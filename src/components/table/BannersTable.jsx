...
export default function BannersTable({
  ...
  useEffect(() => {
    api
      .get(`/banners/get-all?page=${page}&rowsPerPage=${rowsPerPage}`)
            ...
            {data.data?.map((row) => (
              ...
              >
                ...
                >
                  ...
                  >
                    <img src={row.previewBanners} alt=""  style={{height:'100%'}}/>
                  </Box>
                </TableCell>
                <TableCell sx={{ borderBottomStyle: "dashed" }} align="right">
                  <Link to={`/banners/edit/${row.id}`}>
                    <IconButton>
