        ...
        >
          <form
            onSubmit={handleSubmit((data) => {
              ...
              formDataAddUser.append("fullName", data.fullName);
              formDataAddUser.append("email", data.email);
              formDataAddUser.append("phoneNumber", data.phoneNumber);
              formDataAddUser.append("address", data.address);
              formDataAddUser.append("hobby", data.hobby);
              formDataAddUser.append("password", "12345678");
              formDataAddUser.append("role", data.role);
              avatar && formDataAddUser.append("avatar", avatar);

              api
                .post("user/create", formDataAddUser)
                .then((res) => {
