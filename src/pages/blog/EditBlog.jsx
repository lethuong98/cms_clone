...
const EditBlog = () => {
  ...
  useEffect(() => {
    api.get(`/blog/get-one/${id}`).then((res) => {
     
      setValue("title", res.data.data.title);
      setValue("content", res.data.data.content);
      setOldBanners(res.data.data.banners);
      setBanners(() => {
        const newValue = {};
        newValue.preview = res.data.data.banners;
        return newValue;
      });
    });
  }, []);
    ...
    >
      ...
      <form
        onSubmit={handleSubmit((data) => {
          ...
          const formDataUpdateBlog = new FormData();
          formDataUpdateBlog.append("title", data.title);
          formDataUpdateBlog.append("banners", banners);
          formDataUpdateBlog.append(
            "content",
            DOMPurify.sanitize(data.content)
          );
          formDataUpdateBlog.append("bannersChange", bannersChange);
          formDataUpdateBlog.append("oldBanners", oldBanners);
          api
            .put(`/blog/update/${id}`, formDataUpdateBlog)
            .then((res) => {
      ...
      >
        ...
        >
          ...
          <ButtonBlack type="submit" text="Lưu thay đổi" />
        </Box>
      </form>
      <Modal
        open={open}
