import {
  ...
  const Size = () => {
    ...
    const [dataDelete, setDataDelete] = useState({ nameSize: "Này" });
    ...
    const handleDeleteUser = () => {
      ...
      api
        .delete(`/size/delete/${dataDelete.id}`)
        .then((res) => {
      ...
      >
        ...
        >
          ...
          >
            ...
            <Typography sx={{ mt: 2 }}>
              Bạn có chắc muốn xoá size{" "}
              <span style={{ fontWeight: "bold" }}>{dataDelete?.nameSize}</span>{" "}
              không!
            </Typography>
            <Box
              sx={{
