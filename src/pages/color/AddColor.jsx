      ...
      >
        <form
          onSubmit={handleSubmit((data) => {
            const formDataAddColor = new FormData();
            formDataAddColor.append("nameColor", data.nameColor);
            formDataAddColor.append("previewColor", data.previewColor);
            api
              .post("color/create", formDataAddColor)
              .then((res) => {
